  ...
  <div id="cadastro">
    ...
    <form @submit.prevent="gravar()">
      <div class="controle">
        ...
        <input id="titulo" name="titulo" data-vv-as="título" v-validate data-vv-rules="required|min:3|max:20"  autocomplete="off" v-model="foto.titulo">
        <span v-show="errors.has('titulo')">{{ errors.first('titulo') }}</span>
      </div>

      <div class="controle">
        <label for="url">URL</label>
        <input id="url" name="url" v-validate data-vv-rules="required" autocomplete="off" v-model="foto.url">
